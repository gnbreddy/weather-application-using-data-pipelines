...
const Settings = () => {
  ...
  const isSettingsEnabled = process.env.REACT_APP_ENABLE_SETTINGS === "true";

  // If not in admin mode, show access denied
  if (!isAdminMode && !isSettingsEnabled) {
    return (
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-yellow-700 mb-4">
                Settings page is restricted to administrators only. For a free
                public service, AWS and pipeline configurations are managed
                centrally to ensure security and stability.
              </p>
              <div className="bg-white rounded-lg p-4 border border-yellow-200">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>• Data pipeline settings affect all users</li>
                  <li>• Configuration changes could break the service</li>
                  <li>• Security and operational integrity</li>
                </ul>
              </div>
              <div className="mt-4 text-sm text-yellow-600">
                <strong>For Developers:</strong> Set{" "}
                <code>REACT_APP_ADMIN_MODE=true</code> in your .env file to
                access settings.
              </div>
            </div>
          </div>
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Tomorrow.io weather data API key (configured)
            </p>
          </div>
        </div>
      </div>
